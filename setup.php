...
$databasePath = $_ENV['DB_DATABASE'] ?? 'test.sqlite';
...
Logger::info("Connecting to database", ['driver' => $dbType, 'path' => $databasePath]);
...
if ($dbType === 'sqlite') {
    ...
    if (!file_exists($databasePath)) {
        ...
        Logger::info("Database file created", ['file' => $databasePath]);
    }
}
